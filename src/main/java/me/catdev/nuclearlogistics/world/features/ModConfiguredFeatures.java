package me.catdev.nuclearlogistics.world.features;
...
public class ModConfiguredFeatures {
    public static final DeferredRegister<ConfiguredFeature<?, ?>> CONFIGURED_FEATURES =
            DeferredRegister.create(Registry.CONFIGURED_FEATURE_REGISTRY, me.catdev.nuclearlogistics.NuclearLogistics.MOD_ID);
